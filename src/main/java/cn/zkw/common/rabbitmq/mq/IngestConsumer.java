 ...
 */
public class IngestConsumer implements ChannelAwareMessageListener {
    private final static Logger log = Logger.getLogger(IngestConsumer.class);
